  ...
  return (
    ...
    <section className="inner-sub-header bg-gray-100 py-6">
      <div className="container mx-auto text-center py-20">
        ...
        Best PPC Management Company in Bangalore
          ...
          <Breadcrumb>
            <BreadcrumbList className="flex justify-center space-x-2 text-gray-600">
              ...
              <BreadcrumbItem>
               ...
               Best Pay Per Click Management Company in Bangalore
...
<div className="container mx-auto px-4 grid items-center py-5 max-w-7xl sm:px-6 lg:px-8 mt-8 mb-10">
...
<section className="bg-[#3b32f6] text-white py-8">
