...
const tabData = {
    "SMM Package - Organic": {
      ...
      featuresData: [
        ...
        { category: "Reports", 
            features: [
            { name: "Reporting to you", values: ["Monthly", "Monthly", "15 Days"] }
        ] },
        { category: "Support", 
            features: [
            { name: "Support you get", values: ["Email", "Email, Whatsapp, Call", "Email, Whatsapp, Call"] }
        ] },
    ...
    "SMM Package - Paid": {
      ...
      featuresData: [
        ...
        { category: "Reports", 
            features: [
            { name: "Reporting to you", values: ["Monthly", "15 Days", "15 Days"] }
        ] },
        { category: "Support", 
            features: [
            { name: "Support you get", values: ["Email", "Email, Whatsapp, Call", "Email, Whatsapp, Call"] }
...
const [activeTab, setActiveTab] = useState("SMM Package - Organic");
const { pricingPlans, featuresData } = tabData[activeTab];
...
<h3 className="mt-2 mb-5 text-center text-2xl font-medium text-gray-900">Looking to Enhance Your Social Media Marketing Strategy? </h3>
...
<h3 className="mt-2 mb-5 text-center text-2xl font-medium text-gray-900">Web Design & Development Package </h3>
      ...
      <div className="flex justify-center gap-4 mb-4">
        {Object.keys(tabData).map((tab) => (
          <button
            key={tab}
            className={`px-4 py-2 rounded-lg font-semibold ${activeTab === tab ? "bg-blue-600 text-white" : "bg-gray-200 text-black"}`}
...
<div className="container mx-auto">
      <div data-aos="fade-up" data-aos-delay="100">
        ...
        At OrganicAds, our team is made up of skilled professionals with expertise in business, marketing, and technology, making us adept at crafting effective social media marketing strategies. Partnering with OrganicAds’ experienced team ensures you gain a competitive edge in the digital space.
        </p>
        <p className="mb-3 text-justify">
        Our team consists of digital marketing experts, graphic designers, content creators, video specialists, and internet marketers, working collaboratively to establish and enhance your brand’s online presence. Whether you need help with social media campaigns, content creation, or digital marketing strategies, we’ve got you covered.
        </p>
        <p className="mb-3 text-justify">
        We deliver high-quality services at reasonable prices, understanding the importance of cost-effective promotion for your business. Unlike many competitors, we assign projects exclusively to our in-house specialists, ensuring you receive the best expertise at all times.
        </p>
        <p className="mb-3 text-justify">
        ...
        <h3 className="text-2xl font-medium mb-4 mt-7 text-center"> What is the Cost of Social Media Marketing in Bangalore?  </h3>
        <p className="mb-3 text-justify">
        Having a strong presence on social media is essential for every business. At OrganicAds, we focus on driving the growth of businesses by offering affordable social media management packages. The cost of social media marketing in India typically ranges from Rs. 8,000 to Rs. 12,000 per month*, and we also provide customized solutions based on specific client requirements.
        </p>
        <p className="mb-3 text-justify">
        The best part? You can easily find a social media marketing package that perfectly aligns with your company’s needs. Our plans come with features you’ll love at prices that are hard to resist. At OrganicAds, we highly value our clients’ feedback and are committed to tailoring solutions to meet your unique business goals.
        </p>
        <p className="mb-3 text-justify">
        Let us help you create a compelling social media presence with packages designed to deliver results. Choose OrganicAds for cost-effective, result-driven social media marketing services!
        </p>
