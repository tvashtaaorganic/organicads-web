...
const seoCards = [
  ...
  },
  {
    ...
    description:
      "Say goodbye to outdated information and missed chances; we’ll ensure your business is accurately listed across key map platforms like Google Maps for maximum visibility.",
  ...
  },
  {
    title: "Pay Per Click",
    description:
      "Embrace targeted, budget-friendly ads that drive real conversions! With our expertise, we’ll elevate your online visibility and maximize your ROI.",
...
const seoSections = [
  ...
  {
    image: "https://res.cloudinary.com/s2ucdn/image/upload/v1704461205/banner1_qudrg9.png", // Replace with actual image URL
  ...
  {
    image: "https://res.cloudinary.com/s2ucdn/image/upload/v1704461206/banner3_jcp0x1.png", // Replace with actual image URL
    title: "Stay Ahead of the Competition with Superior SEO Strategies",
    description: "In today’s digital world, playing the SEO game better than your competitors is crucial for staying relevant and visible. Without a strong SEO strategy, your brand risks being left behind. SEO involves many complex factors, from on-page optimization to staying updated on algorithm changes and best practices. Keeping up can be challenging, but with our expertise, you can outpace the competition. By partnering with us, we’ll ensure your SEO game is always one step ahead, driving more traffic, boosting rankings, and maximizing your online presence for long-term success. Let us help you rise above the competition with expert SEO strategies tailored to your business goals."
  }
];
...
<div className="flex justify-center">
        <Carousel
          opts={{
            align: "start",
           // slidesToShow: 2, // Ensures 2 items per slide on mobile
...
<div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 items-center mt-10 mb-20 sm:mt-10 font-poppins max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
  ...
  <div className="md:col-span-7 text-justify px-2">
    ...
    <p className="mt-4 text-gray-700">
    We offer specialized SEO services, social media marketing, website design, development, and digital marketing solutions. Our strategies are rooted in ethical practices and transparency. With us, you won’t be tied down by restrictive SEO contracts-just trust and results.
    </p>
    <p className="mt-4 text-gray-700">
    As a leading SEO service provider in Bangalore, we understand your unique needs, priorities, and challenges. With our expertise, we can help you achieve sustainable growth and success. Let’s talk today and ease your concerns.
    </p>
    <p className="mt-4 mb-7 text-gray-700">
    Since 2016, we’ve been delivering top-tier SEO services in Bangalore, helping brands from diverse industries rank higher in Google search results. We’ve cracked the code to solving the toughest SEO and digital marketing challenges by understanding what works and what doesn’t. Recognizing that SEO is a long-term investment, we offer affordable solutions for small businesses and new entrepreneurs to help them succeed and grow.
    </p>
...
<div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 items-center mt-10 mb-5 sm:mt-10 px-2 sm:px-0 font-poppins max-w-7xl py-5">
  ...
  <div className="col-span-12 md:col-span-6 flex justify-center">
    <img
      ...
      className="w-full sm:w-[80%] md:w-[90%] lg:w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-lg h-auto object-cover rounded-lg"
    />
  </div>
