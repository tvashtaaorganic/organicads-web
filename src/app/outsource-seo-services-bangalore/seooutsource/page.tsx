...
const SeoOutsourceContent = () => {
    ...
    const benefits = [
      ...
      const previewText = text.substring(0, 300) + "..."; // Show first 300 characters
...
<section className="container mx-auto mt-3 mb-3 w-full px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div className="text-left mt-8">
          <Button asChild className="rounded-lg inline-flex justify-left items-left text-sm font-semibold py-3 px-4 bg-slate-900 text-white hover:bg-slate-700 pointer-events-auto">
            <a href="/seo-cost-calculator">
            SEO Cost Caculator <ArrowRight />
            </a>
          </Button>
        </div>
          </div>
          ...
          {benefits.map((item, index) => (
            <Card key={index} className="shadow rounded-lg">
              <CardContent className="p-6 text-center">
                <img src={item.img} alt={item.alt} className="mx-auto mb-4 w-20 h-20" />
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 pb-10">
        <div className="max-w-7xl mx-auto" data-aos="fade-up">
          ...
          <div className="text-center mt-4">
            <Button onClick={() => setIsExpanded(!isExpanded)} className="rounded-lg inline-flex justify-left items-left text-sm font-semibold py-3 px-4 bg-white text-black hover:bg-blue-700 hover:text-white pointer-events-auto transition">
