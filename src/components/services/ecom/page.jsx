...
const stats = [
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 items-center mt-2 mb-5 font-poppins max-w-7xl px-4 sm:px-6 lg:px-6">
      ...
      <section className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-7 font-poppins">
